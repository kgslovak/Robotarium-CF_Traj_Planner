...
class Coord3D():
    def __init__(self, ax, initpos, roll=0.0, pitch=0.0, yaw=0.0, trans=1.0):
        ...
        self.pos = initpos
        self.disk1 = pch.Circle((initpos[0]+self.r0/sqrt(2), initpos[1]+self.r0/sqrt(2)), self.r1, alpha=trans)
        self.disk2 = pch.Circle((initpos[0]+self.r0/sqrt(2), initpos[1]-self.r0/sqrt(2)), self.r1, alpha=trans)
        self.disk3 = pch.Circle((initpos[0]-self.r0/sqrt(2), initpos[1]+self.r0/sqrt(2)), self.r1, alpha=trans)
        self.disk4 = pch.Circle((initpos[0]-self.r0/sqrt(2), initpos[1]-self.r0/sqrt(2)), self.r1, alpha=trans)
